...
def g_iter(n):
    ...
    g1, g2, g3, k = 1, 2, 3, 4
    while k <= n:
        g1, g2, g3, k = g2, g3, g3 + 2*g2 + 3*g1, k + 1
    return g3
...
def make_anonymous_factorial():
    ...
    120
    >>> make_anonymous_factorial()(0)
    1
    >>> make_anonymous_factorial()(1)
    1
    >>> from construct_check import check
    ...
    True
    """
    return (lambda f: lambda x: f(f, x))(lambda f, x: 1 if x == 1 or x == 0 else x * f(f, x-1))
