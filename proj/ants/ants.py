...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not place.is_hive and self.upper_bound >= distance >= self.lower_bound:
            if place.bees:
        ...
        while place:
            if place.ant:
                if not place.ant.is_doubled:
                    place.ant.double()
                if place.ant.is_container and place.ant.ant_contained and not place.ant.ant_contained.is_doubled:
